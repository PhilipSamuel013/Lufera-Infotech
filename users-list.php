...
<?php
    ...
    $sql = "SELECT * FROM users_details ORDER BY created_at ASC";
    ...
    $sql = "SELECT * FROM users_details ORDER BY created_at ASC LIMIT $start_from, $records_per_page";
    $result = mysqli_query($conn, $sql);

    // Get the total number of records
    $total_sql = "SELECT COUNT(*) FROM users_details";
