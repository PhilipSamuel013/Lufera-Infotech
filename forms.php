                                        ...
                                        <form action="" method="post" role="form">
                                            ...
                                            <fieldset class="wizard-fieldset show">
                                                ...
                                                <label for="fname" class="">Company Name*</label>    
                                                    <input type="text" class="form-control wizard-required" id="fname" name="comp_name">
                                                    <div class="wizard-form-error text-danger">Fill out company name</div>
                                                </div>
                                                <div class="form-group">
                                                <label for="lname" class="">Contact Person*</label>
                                                    <input type="text" class="form-control " id="lname" name="cont_person">
                                                ...
                                                <label for="lname" class="">Website*</label>
                                                    <input type="text" class="form-control " id="lname" name="website">
